...
$arLeadFields = array(
    "TITLE" => 'Запрос с сайта Atrium Avenue ' .  $_POST['name'] .  $_POST['phone'],
    "NAME" => $_POST["name"],
    "PHONE" => [
        ["VALUE" => htmlspecialchars($_POST['phone']), "VALUE_TYPE" => "WORK"]
    ],
    "SOURCE_ID" => 'WEB',
    "SOURCE_DESCRIPTION" => 'atriumavenue', // сюда домен сайта откуда запрос шлем
...
if($post) {
  ...
  if(!$error) {
    $eml = array(
      'html'    => '<p>'.$mes.'</p>',
      'text'    => $mes,
      'subject' => 'Atrium Avenue: заявка с сайта',
      'from'    => array(
        'name'  => 'Landind',
